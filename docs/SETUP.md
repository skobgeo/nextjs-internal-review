...
pnpm lint        # зелёный (несколько предупреждений — они по делу)
pnpm build       # зелёный
pnpm test        # в ветке session-1 КРАСНЫЙ: 47 падающих тестов — это задания сессии 1
                 # в ветках session-2 и session-3 — зелёный
```

Поднимите окружение и проверьте эти команды **до** сессии: сборка нативного модуля
