...
Лежат в `apps/web/public/images/articles/<slug>.jpg` (1280×720) и закоммичены.
...
pnpm lint        # зелёный (два предупреждения про <img> — они по делу, см. T-05)
pnpm build       # зелёный (нужен запущенный API: статьи предгенерируются)
pnpm test        # КРАСНЫЙ: 6 падающих тестов в @repo/core — это задания T-02 и T-06
```
